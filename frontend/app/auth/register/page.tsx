        ...
        <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-slate-950">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    ...
                    className="absolute -top-[20%] -right-[10%] w-[60%] h-[60%] rounded-full bg-indigo-500/20 blur-[120px]"
                />
                <motion.div
                    animate={{
                        scale: [1, 1.3, 1],
            ...
            >
                ...
                <motion.div variants={itemVariants} className="mb-10 text-center space-y-4">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-[2.5rem] bg-gradient-to-tr from-indigo-500 to-sky-600 shadow-xl shadow-indigo-500/20 mb-4 transform hover:-rotate-12 transition-transform duration-500">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 font-medium text-lg">Forge your identity. Build your empire.</p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        <motion.div variants={itemVariants} className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 w-5 h-5 group-focus-within/input:text-sky-400 transition-colors" />
                                <input
                                    type="text"
                                    required
                                    value={name}
                                    ...
                                    placeholder="The Forge Master"
                                />
                            </div>
                        </motion.div>

                        <motion.div variants={itemVariants} className="space-y-2">
                            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Email Coordinates</label>
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-4 bg-white/5 border border-white/10 rounded-2xl text-white font-medium focus:ring-4 focus:ring-sky-500/10 focus:border-sky-500/50 outline-none transition-all placeholder:text-slate-600"
                                    placeholder="master@skillforge.com"
                                />
                            </div>
                        </motion.div>
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-tr from-indigo-500 to-sky-600 hover:from-indigo-400 hover:to-sky-500 text-white py-4 rounded-2xl flex items-center justify-center space-x-2 text-lg font-bold shadow-xl shadow-indigo-500/20 transition-all disabled:opacity-50"
                        >
                            {loading ? (
                    ...
                    <motion.div variants={itemVariants} className="mt-10 pt-8 border-t border-white/5 text-center relative z-10">
                        <p className="text-sm text-slate-400 font-medium">
                            ...
                            <Link href="/auth/login" className="text-sky-400 font-black hover:text-sky-300 transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </motion.div>
